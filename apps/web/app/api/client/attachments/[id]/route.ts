...
export async function GET(request:Request,{params}:{params:Promise<{id:string}>}){
  ...
  if((process.env.DEMO_MODE??"true")==="true")return new Response("Synthetic proof attachment",{headers:{"content-type":"text/plain","content-disposition":"attachment; filename=demo-proof.txt","cache-control":"no-store","x-content-type-options":"nosniff"}});
